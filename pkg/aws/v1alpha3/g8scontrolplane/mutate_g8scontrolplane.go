...
func (m *Mutator) MutateUpdate(request *admissionv1.AdmissionRequest) ([]mutator.PatchOperation, error) {
	...
	g8sControlPlaneNewCR := &infrastructurev1alpha3.G8sControlPlane{}
	g8sControlPlaneOldCR := &infrastructurev1alpha3.G8sControlPlane{}
	...
	patch, err = m.MutateInfraRef(*g8sControlPlaneNewCR)
	if err != nil {
		return nil, microerror.Mask(err)
	}
	result = append(result, patch...)
...
func (m *Mutator) MutateCreate(request *admissionv1.AdmissionRequest) ([]mutator.PatchOperation, error) {
	...
	g8sControlPlaneCR := &infrastructurev1alpha3.G8sControlPlane{}
...
func (m *Mutator) MutateControlPlaneLabel(g8sControlPlane infrastructurev1alpha3.G8sControlPlane) ([]mutator.PatchOperation, error) {
...
func (m *Mutator) MutateReplicaUpdate(g8sControlPlaneNewCR infrastructurev1alpha3.G8sControlPlane, g8sControlPlaneOldCR infrastructurev1alpha3.G8sControlPlane, awsControlPlane infrastructurev1alpha3.AWSControlPlane) ([]mutator.PatchOperation, error) {
	var result []mutator.PatchOperation
...
func (m *Mutator) MutateInfraRef(g8sControlPlane infrastructurev1alpha3.G8sControlPlane) ([]mutator.PatchOperation, error) {
	var result []mutator.PatchOperation
...
func (m *Mutator) MutateReplicas(availabilityZones int, g8sControlPlane infrastructurev1alpha3.G8sControlPlane, releaseVersion *semver.Version) ([]mutator.PatchOperation, error) {
	var result []mutator.PatchOperation
...
func isUpdateFromSingleToHA(g8sControlPlaneNewCR infrastructurev1alpha3.G8sControlPlane, g8sControlPlaneOldCR infrastructurev1alpha3.G8sControlPlane, awsControlPlane infrastructurev1alpha3.AWSControlPlane) bool {
